...
| :-------- | :---------- | :--- | :--- | :-------- | :-------- |
| 1 초      | 512 MB      | 5015 | 1492 | 1092      | 28.935%   |
...
![img](https://onlinejudgeimages.s3-ap-northeast-1.amazonaws.com/problem/15787/1.png)
...
## 회고
if 배열 == 배열: 로 중복을 없애려 했지만 뭔가 오류가 있는거 같았다 ㅠㅠ
그래서 배열을 문자열로 바꾼다음 set을 해주어 중복제거 해주었다.
이게 훨씬 쉽고 깔끔해서 좋다.